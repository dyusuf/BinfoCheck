...
**Status:** Offline implementation and acceptance fixtures completed on
`codex/t04-claim-extraction`; see [T04 handoff](t04-handoff.md). Live integration is
blocked by unavailable GenerationModel access and absent request-bound authorization.
Check 3 remains outstanding; T04 is not fully accepted. Shared contracts and T03
remain unchanged; extraction-only D07 resources are selected.
